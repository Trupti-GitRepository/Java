	...
	private class ButtonEventHandler implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent e) {
			...
			if (e.getSource() == conversionBtn) {
				...
				} catch (NumberFormatException | StackOverflowException | StackUnderflowException
				...
				try {
					...
					try {
						double a = Notation.evaluatePostfixExpression(postfixExpr);
							...
							| InvalidNotationFormatException e1) {
			...
			// For evaluate In button
				...
				try {
					...
					JOptionPane.showMessageDialog(null, exception.getMessage());
				} catch (StackUnderflowException | InvalidNotationFormatException exception) {
					JOptionPane.showMessageDialog(null, exception.getMessage());
				}
