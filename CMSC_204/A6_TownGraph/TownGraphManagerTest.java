...
public class TownGraphManagerTest {
	...
	public void testAddRoad() {
		...
		assertEquals("Road_10", roads.get(9));
		assertEquals("Road_11", roads.get(10));
		assertEquals("Road_12", roads.get(11));
		...
		assertEquals("Road_11", roads.get(10));
		assertEquals("Road_12", roads.get(11));
		assertEquals("Road_13", roads.get(12));
	...
	public void testAllTowns() {
		...
		assertEquals("Town_10", roads.get(9));
		assertEquals("Town_11", roads.get(10));
